...
tf.app.flags.DEFINE_string('prune_dir', './cifar10_sneval',
                           """Directory where to write event logs.""")
tf.app.flags.DEFINE_string('checkpoint_dir', './cifar10_sntrain',
                           """Directory where to read model checkpoints.""")
tf.app.flags.DEFINE_string('retrain_dir', './cifar10_snretrain',
...
def prune():
    ...
    with tf.Graph().as_default() as g:
        ...
        images, labels = sn.inputs(eval_data=True)
...
def main():
    # r, p = prune()
    r = np.arange(0, 0.2, 0.01)
    p = np.array((0.834, 0.828, 0.809, 0.767, 0.728, 0.618, 0.544, 0.376, 0.325, 0.265,
                  0.222, 0.183, 0.170, 0.132, 0.135, 0.109, 0.102, 0.103, 0.101, 0.102))
